...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section padding="80px 0" sm-padding="40px 0">
			...
			>
				<br />
				This privacy policy outlines how THARASA FOOD ADDA manages and protects any information you provide when using our website or apps.
				<br />
				<br />
				<Strong
				...
				{"\n"}THARASA FOOD ADDA is dedicated to ensuring the protection of your privacy. Any information collected will be used in accordance with this privacy statement.
				<br />
				<br />
				<Strong
					overflow-wrap="normal"
				...
				{"\n"}THARASA FOOD ADDA may update this policy periodically by revising this page. It is recommended to check this page from time to time to ensure you are satisfied with any changes.
				<br />
				<br />
				<Strong
					overflow-wrap="normal"
